...
import com.shoutin.service.ContactSyncService;
...
//        incomingSms = new IncomingSms(this);
        ...
        try {
            ...
            objEditor.putString(Constants.OTP_VERIFIED, "0");
            objEditor.commit();
        }
    }
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (s.length() == 4) {
                    ...
                    if (view != null) {
                        ...
                        if ((edtOtp.getText().toString().length() > 0 || !edtOtp.getText().toString().isEmpty())) {
                            linearOtpSuccess.setVisibility(LinearLayout.GONE);
                            linearOtpFailed.setVisibility(LinearLayout.GONE);
            ...
            try {
                ...
                if (s.length() > 0) {
                    ...
                    if (objJsonObject.getString("result").toString().equals("true")) {
                        ...
                        Answers.getInstance().logCustom(new CustomEvent("Otp Verification")
