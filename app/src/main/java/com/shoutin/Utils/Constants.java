...
import static com.shoutin.Utils.ConnectivityBroadcastReceiver.objConnectivity;

public class Constants {

//  PRODUCTION SHA1:  5B:1C:96:09:49:FA:95:7D:9B:11:6A:89:82:CF:B1:F5:C6:0F:3A:DF

    public static final String SHOUT_UPDATE_INTENT = "com.shoutin.shoutupdate";
    public static final String APPLICATION_PLAYSTORE_PATH = "https://play.google.com/store/apps/details?id=com.shoutin";

    public static final int SPLASHSCREENTIME = 3000;
    public static final int PLAY_SERVICES_RESOLUTION_REQUEST = 9000;
    public static final int DEFAULT_CIRCLE_PADDING = 3;
    public static final int DEFAULT_REDIUS = 100;
    ...
    public static final String PLAY_STORE_URL = "https://play.google.com/store/apps/details?id=com.shoutin&hl=en";
    public static final String APP_PACKAGE_NAME = "com.shoutin";
    ...
    public static final String HTTP_URL = "http://admin.shoutin.co/";
    public static final String THUMB_BASE_URL = "http://admin.shoutin.co/files/shout/";
    public static final String BASE_URL = "http://admin.shoutin.co/api/";
    //    public static final String SHOUT_SHARE_LINK = "http://admin.shoutin.co/shout/list/";
    public static final String SHOUT_SHARE_LINK = "http://shouts.shoutin.co/share/";

    public static final String PREFERENCE_SHOUT_API = BASE_URL + "shout/pref";
    ...
    public static final String GET_ALL_CITIES = BASE_URL + "user/city";
    ...
    public static final String USER_SPREAD_THE_LOVE_CONTENT = "spread_the_love_share_content"; // Shareing content on click of drawer Spread the love menu.
...
//        final int initialWidth = v.getMeasuredWidth();
    ...
    public static final String EVENT_CREATE_SHOUT = "Create Shout";
    public static final String EVENT_SHOUT_LIKE = "Shout Like";
    public static final String EVENT_CONTACT_SYNC = "Shoutbook Sync";
    public static final String EVENT_USER_LOGIN = "User Login";
    public static final String EVENT_USER_REGISTER = "User Register";
    public static final String EVENT_SHOUT_COMMENT = "Shout Comment";
    public static final String EVENT_I_NEED_IT = "I Need It";
    public static final String EVENT_I_CAN_HELP = "I Can Help";
    public static final String EVENT_USER_HANDSHALKE = "Chat Handshake";
    public static final String EVENT_SHOUT_HIDE = "Shout Hide";
    public static final String EVENT_EDIT_SHOUT = "Edit Shout";
    public static final String EVENT_CHANGE_PREFERENCE = "Change Preference";
    public static final String EVENT_ACCEPT_REQUEST = "Shoutbook Accept Request";
    public static final String EVENT_MENU_CLICK = "Drawer Menu Click";
