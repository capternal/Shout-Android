...
import com.shoutin.main.Adapter.GridViewResourceAdapter;
import com.shoutin.main.Model.CategoryModel;
import com.shoutin.main.Model.GridViewResourceModel;
...
public class CreateShoutActivity extends BaseActivity implements View.OnClickListener, OnMapReadyCallback, ConnectivityBroadcastReceiver.ConnectivityReceiverListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityContext = CreateShoutActivity.this;
            ...
            try {
                ...
                if (geocoder.isPresent()) {
                    if (addresses.size() > 0) {
                        ...
                        System.out.println("ADMIN ADDRESS: " + addresses.get(0));
                        System.out.println("ADMIN LINE 1 : " + addresses.get(0).getAddressLine(0));
                        System.out.println("ADMIN LINE 2 : " + addresses.get(0).getAddressLine(1));
                        System.out.println("ADMIN LINE 3 : " + addresses.get(0).getAddressLine(2));
            ...
            try {
                ...
                if (objJsonObject.getString("result").equals("true")) {
                    ...
                    if (arrResourceType.size() > 0) {
                        ...
                        Answers.getInstance().logCustom(new CustomEvent(Constants.EVENT_CREATE_SHOUT)
                                .putCustomAttribute("Shout Id", objJsonObject.getString("shout_id"))
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (objJsonObject.getString("result").toString().equals("true")) {
                    ...
                    SharedPreferences objSharedPreferences = getSharedPreferences(Constants.PROFILE_PREFERENCES, MODE_PRIVATE);
                    Answers.getInstance().logCustom(new CustomEvent(Constants.EVENT_CREATE_SHOUT)
                            .putCustomAttribute("Shout Id", shoutId)
                            .putCustomAttribute("User Id", objSharedPreferences.getString(Constants.USER_ID, ""))
                            .putCustomAttribute("Username", objSharedPreferences.getString(Constants.USER_NAME, ""))
                            .putCustomAttribute("Facebook Id", objSharedPreferences.getString(Constants.USER_FACEBOOK_ID, ""))
                            .putCustomAttribute("Email Id", objSharedPreferences.getString(Constants.PROFILE_EMAIL_ID, ""))
