package com.shoutin.main.EditShout;
...
import com.shoutin.Utils.RealPathUtil;
...
import com.shoutin.main.EditShout.Adapter.EditCategoryAdapter;
import com.shoutin.main.EditShout.Adapter.EditGridViewResourceAdapter;
import com.shoutin.main.EditShout.Model.EditCategoryModel;
import com.shoutin.main.EditShout.Model.EditGridViewResourceModel;
import com.shoutin.main.EditShout.Model.OriginalDataModel;
...
import com.shoutin.service.UploadResourceService;
...
//                    objTextViewMapAddress.setVisibility(TextView.GONE);
            ...
            try {
                ...
                if (geocoder.isPresent()) {
                    if (addresses.size() > 0) {
                        ...
                        adminArea = addresses.get(0).getAddressLine(1) + " " + addresses.get(0).getAddressLine(2);
    ...
    private void setIntentData() {
        ...
        adminArea = data.getString(ShoutDetailActivity.EDIT_SHOUT_SHORT_ADDRESS);
    ...
    private void allClickEvents() {
        ...
        objLinearLayoutSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                try {
                    Intent intent = new PlaceAutocomplete.IntentBuilder(PlaceAutocomplete.MODE_FULLSCREEN).build(EditShoutActivity.this);
        ...
        objImageSearchAddress.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                try {
                    Intent intent = new PlaceAutocomplete.IntentBuilder(PlaceAutocomplete.MODE_FULLSCREEN).build(EditShoutActivity.this);
    ...
    public class EditShout extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                objJsonObject.put("short_address", adminArea);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (objJsonObject.getString("result").equals("true")) {
                    ...
                    Answers.getInstance().logCustom(new CustomEvent(Constants.EVENT_EDIT_SHOUT)
