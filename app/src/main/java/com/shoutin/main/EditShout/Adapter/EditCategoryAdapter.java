package com.shoutin.main.EditShout.Adapter;
...
public class EditCategoryAdapter extends BaseAdapter {
    ...
    ArrayList<EditCategoryModel> arrStrDummyDirectoryGridItemName;

    public EditCategoryAdapter(Context context, ArrayList<EditCategoryModel> arrStrDummyDirectoryGridItemName) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final EditCategoryModel objCategoryModel = arrStrDummyDirectoryGridItemName.get(position);
            ...
            public void onClick(View v) {
                if (objCategoryModel.getFlag() == 0) {
                    for (int index = 0; index < arrStrDummyDirectoryGridItemName.size(); index++) {
                        EditCategoryModel objCategoryModelTemp = arrStrDummyDirectoryGridItemName.get(index);
