...
import com.shoutin.main.Adapter.NotificationListAdapter;
    ...
    private void initialize() {
        ...
        objNotificationList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                } else if (arrNotificationListModel.get(i).getNotification_type().equals("CO") || arrNotificationListModel.get(i).getNotification_type().equals("LC") || arrNotificationListModel.get(i).getNotification_type().equals("CS") || arrNotificationListModel.get(i).getNotification_type().equals("O")) {
