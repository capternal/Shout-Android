package com.shout.shoutin.database;
...
import com.shout.shoutin.main.Adapter.UploadResourceModel;
   ...
   /* @Override
    ...
    public ArrayList<ShoutDefaultListModel> getShoutDefaultListModelArray(String owner_flag, String strPreferenceId, boolean inSearchMode) {
        ...
        try {
            ...
            String strQuery = "SELECT * FROM " + strTableNameShout + " WHERE " + this.strIsOwnerShoutFlag + "='" + owner_flag + "' ORDER BY " + strShoutId + " DESC";
