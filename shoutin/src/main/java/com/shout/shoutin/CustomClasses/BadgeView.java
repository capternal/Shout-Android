...
package com.shout.shoutin.CustomClasses;
...
public class BadgeView extends TextView {
    ...
    private static final int DEFAULT_BADGE_COLOR = Color.parseColor("#FFFFFF");
    private static final int DEFAULT_TEXT_COLOR = Color.parseColor("#E62948");
